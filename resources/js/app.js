...
document.addEventListener("DOMContentLoaded", function(event) {
    window.addEventListener("load", function() {
        ...
        const nav = this.document.querySelector(".main-nav");
        ...
        trigger3Tl
            .from(
                ".trigger-3 .js-fade-left",
                0.75,
                { opacity: 0, x: -70 },
                "-=1"
            )
            .from(
                ".trigger-3 .js-fade-down",
                0.75,
                { opacity: 0, y: -70 },
                "-=1"
            )
        ...
        let navTrigger = new ScrollMagic.Scene({
            triggerElement: "body",
            offset: 50,
            triggerHook: 0
        })
            .setClassToggle(".main-nav", "scroll-nav-active")
            .addTo(controller);
    });
});
